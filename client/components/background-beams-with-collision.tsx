  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-green-500 via-green-800 to-transparent",
    ...
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-green-500 to-green-800"
        />
      ))}
    </div>
  );
